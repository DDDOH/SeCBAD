...
def get_args(rest_args):
    ...
    parser.add_argument('--learner_type', default='oracle_truncate',
    ...
    parser.add_argument('--exp_label', default='oracle_truncate',
    ...
    # general settings
    parser.add_argument('--seed',  nargs='+', type=int, default=[95]) # 12, 66, 95
