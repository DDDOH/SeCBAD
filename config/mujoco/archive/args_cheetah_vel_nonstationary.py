...
def get_args(rest_args):
    ...
    # add string argument, select from 'ori', 'meta', 'orical_truncate', 'adaptive'
    # meta is the original varibad, i.e., metalearner.py
    # ori is learner.py
    # oracle_truncate is oracle_truncate_learner.py
    # adaptive is adaptive_learner.py
    parser.add_argument('--learner_type', default='adaptive',
                        help="select from ori, meta, oracle_truncate, adaptive")
    ...
    parser.add_argument('--exp_label', default='adaptive',
                        help='label (typically name of method)')
    parser.add_argument(
        '--env_name', default='HalfCheetahVelNonstationary-v0', help='environment to train on')
    ...
    parser.add_argument('--norm_state_for_policy', type=boolean_argument,
                        default=True, help='normalise state input')
    ...
    parser.add_argument('--norm_belief_for_policy', type=boolean_argument,
                        default=True, help='normalise belief input')
    parser.add_argument('--norm_task_for_policy', type=boolean_argument,
                        default=True, help='normalise task input')
    ...
    # RL algorithm
    parser.add_argument('--policy', type=str, default='adaptive_ppo',
                        help='choose: a2c, ppo')
    ...
    parser.add_argument('--policy_tau', type=float,
                        default=0.9, help='gae parameter')
    ...
    parser.add_argument('--encoder_gru_hidden_size', type=int,
                        default=128, help='dimensionality of RNN hidden state')
    ...
    parser.add_argument('--vis_interval', type=int, default=300,
    ...
    # general settings
    parser.add_argument('--seed',  nargs='+', type=int, default=[12]) # 12, 66, 95
