...
def get_args(rest_args):
    ...
    parser.add_argument('--learner_type', default='adaptive',
                        help="select from ori, meta, orical_truncate, adaptive")
    ...
    parser.add_argument('--max_rollouts_per_task', type=int,
                        default=1, help='number of MDP episodes for adaptation')
    parser.add_argument('--exp_label', default='adaptive',
                        help='label (typically name of method)')
    parser.add_argument(
        '--env_name', default='HalfCheetahWindStayNonstationary-v0', help='environment to train on')
