    ...
    def __init__(self,
        ...
        if self.args.pass_latent_to_policy:
            ...
            self.hidden_states = torch.zeros(
                num_steps + 1, num_processes, hidden_size)
        ...
        if 'detailed_reward' in kwargs.keys():
            if kwargs['detailed_reward']:
                self.ctrl_reward = torch.zeros(num_steps, num_processes, 1)
                self.vel_reward = torch.zeros(num_steps, num_processes, 1)
